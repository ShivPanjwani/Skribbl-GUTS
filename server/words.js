// Word lists for DrawIt game (server-side copy)
...
const HARD_WORDS = [
  ...
  { word: 'Sanctuary', category: 'PLACE' },
  { word: 'Planetarium', category: 'PLACE' },
];

export const generateWordOptions = async (round = 1, excludeWords = []) => {
...
export default { generateWordOptions };
